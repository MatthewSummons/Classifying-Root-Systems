...
Since we aim to classify all root systems, up to isomorphism, it is important to understand when two root systems are
isomorphic. \newline
...
\section{Formalisng Classification of Rank 1 Root Systems in Lean 4}
...
% \centering
% \begin{tabular}{cc}
% \subcaptionbox{caption}{\includegraphics[width = 2in]{A1xA1.png}} &
% \subcaptionbox{caption}{\includegraphics[width = 2in]{A2.png}} \\
% \subcaptionbox{caption}{\includegraphics[width = 2in]{B2.png}} &
% \subcaptionbox{caption}{\includegraphics[width = 2in]{G2.png}}\\
% \end{tabular}
% \caption{caption}
% \end{figure}